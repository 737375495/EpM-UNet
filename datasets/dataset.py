...
class NPY_datasets(Dataset):
    def __init__(self, path_Data, config, train=True):
        ...
        if train:
            ...
            masks_list = sorted(os.listdir(path_Data+'train/labels/'))
            self.data = []
            for i in range(len(images_list)):
                img_path = path_Data+'train/images/' + images_list[i]
                mask_path = path_Data+'train/labels/' + masks_list[i]
                self.data.append([img_path, mask_path])
            self.transformer = config.train_transformer
        else:
            images_list = sorted(os.listdir(path_Data+'val/images/'))
            masks_list = sorted(os.listdir(path_Data+'val/labels/'))
            self.data = []
            for i in range(len(images_list)):
                img_path = path_Data+'val/images/' + images_list[i]
                mask_path = path_Data+'val/labels/' + masks_list[i]
                self.data.append([img_path, mask_path])
